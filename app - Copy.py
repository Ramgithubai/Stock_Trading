...
def format_portfolio_output(result, tickers, portfolio):
    """Format the output from the hedge fund for display"""
...
def run_single_hedge_fund(
    ...
    """Run the hedge fund with the provided parameters"""
    # Parse tickers
...
def create_app():
    ...
    with gr.Blocks(title="AI Hedge Fund") as app:
        gr.Markdown("# AI Hedge Fund")
        gr.Markdown("A proof of concept for an AI-powered hedge fund")
